...
'core_comment', 'comment', 'soil cores were collected at 25 m intervals close to the grazing center, and spaced to 50 and 100 m further from the center',  paste('Method ln74:', paste(data.lvl0.df$method[74], collapse = ' ')) )
  ...
  from_source = 'Table 1 column names.') |>
   ...
   bind_rows(
    tribble(~of_variable, ~method, ~from_source,
           ...
           'total_organic_carbon',  paste0(data.lvl0.df$method[c(94, 96, 98)], collapse = ' '), 'Methods ln94;96;98') |>
