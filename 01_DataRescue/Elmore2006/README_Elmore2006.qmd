...
studyMeta <- tribble(~of_variable, ~is_type, ~with_entry, ~from_source,
                   ...
                   'land_use_type', 'value', 'Cattle grazing', paste('Method ln21:', paste(data.lvl0.df$method[21], collapse = ' ')),
                   'land_use_type', 'interval', '1900',  paste('Method ln21:', paste(data.lvl0.df$method[21], collapse = ' ')),
                   'land_use_type', 'interval_format', 'YYYY', NA)
