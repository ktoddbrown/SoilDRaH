...
if(file.exists(readsource.file)){
  datafunction.lvl0.ls <- readElmore2006(dataDir = '.',
                                         dataLevel = 'level0')
...
data.lvl1.ls <- list(
  ...
  primary = bind_rows(Table1Primary)|>
    mutate(grazing_id = with_entry[of_variable == 'sample_id'],
           is_type = 'value',
           .by = row_id) |>
   arrange(row_id, grazing_id, column_name,
...
if(file.exists(readsource.file)){
  datafunction.lvl1.ls <- readElmore2006(dataDir = '.',
                                         dataLevel = 'level1')
