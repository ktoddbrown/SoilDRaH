...
source('../../02_DataHarmonization/readNCSS.R') #load in the read function
...
```{r echo=FALSE}
dataDirectory <- '~/UF Dropbox/Kathe Todd-Brown/Research/Datasets/NRCS_NCSS_20230922/'
```
...
ncss.df <- readNCSS(dataDir = dataDirectory,
                    annotationFilename = 'NCSS_Annotations.csv',
                    #format = 'long')
                    format = 'original')
