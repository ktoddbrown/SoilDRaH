...
bibliography:
  - Barba2016_Methods.bib #contains the citations in the methods section
  - Barba2016.bib #contains citation for the data source, generally a single citation of the primary paper
...
methods.file <- "Barba2016_Methods.md"
Table2.file <- 'Barba2016_Table2.csv'
figure4.file <- 'Barba2016_Figure4.csv'

# Bibliography files
primaryCitation.file <- 'Barba2016.bib'
methodsCitation.file <- 'Barba2016_Methods.bib'
...
This paper examines how drought-induced forest die-off and subsequent tree species replacement of Pinus sylvestris L. (Scots pine) by Quercus ilex L. ssp. ilex (Holm oak) affect above- and belowground litter decomposition in a mixed Mediterranean forest in the Prades Mountains, Spain.
...
diff --strip-trailing-cr --suppress-common-lines -y temp/Barba2016_Table2_ABC.md Barba2016_Table2.md
```
...
# You will want to repeat the line below to cross check each csv and md file in the
#... data rescue. Having no lines flagged by this command will ensure that each character matches exactly.
diff --strip-trailing-cr --suppress-common-lines -y temp/Barba2016_Methods_ABC.md Barba2016_Methods.md
```
