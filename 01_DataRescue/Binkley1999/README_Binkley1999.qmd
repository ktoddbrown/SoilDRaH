...
mutate(lowerbound = str_extract(with_entry, '^\\d+(?=-)'),
         upperbound = str_extract(with_entry, '(?<=\\d-)\\d+$'),
...
#Still working on table 1; don't know how to deal with the C/F marked plots or the final row
