...
Table 1 was modified by filling in blanks with `NA`, modifying Age column to also include duration, flagging rows as either stock or change, and down filling the Age/duration column.
...
land_use.df <- tibble(~land_use_id, ~of_variable, ~is_type, ~with_entry, ~from_source,
                      ...
                      'LU2', 'land_use', 'duration', 'P80Y', paste('Method ln3:', data.lvl0.ls$method[3])
)
...
Table1Primary <- data.lvl0.ls$data$Table1$primary |>
   ...
   pivot_longer(cols = -c(row_id, `Stock or change`),
    ...
    mutate(of_variable = case_when(
      #column_name == 'Stock or change' ~ 'is_type',
      column_name == "Age/duration (mo)" ~ "stand_age",
      column_name == "Depth (cm)" ~ "layer",
      column_name == "C (g m<sup>-2</sup>)" ~ "organic_carbon",
      column_name == "N (g m<sup>-2</sup>)" ~ "nitrogen",
      column_name == "pH<sub>CaCl2</sub>" ~ "ph",
      column_name == "Ca (mmol m<sup>-2</sup>)" ~ "calcium",
      column_name == "Mg (mmol m<sup>-2</sup>)" ~ "magensium",
      column_name == "C K† (mmol m<sup>-2</sup>)" ~ "potassium",
      column_name == "F K† (mmol m<sup>-2</sup>)" ~ "potassium",
      column_name == "Al (mmol m<sup>-2</sup>)" ~ "aluminum",
      .default = 'Bad Match')) |>
