...
studyMeta <- tribble(~of_variable, ~is_type, ~with_entry, ~source,
                   ...
                   'latitude', 'value', '19°50\'28.1" N', paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
                   'longitude', 'value', '155°7\'28.3" W', paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
                   'mean_air_temperature', 'value', '21°C',paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
                   'elevation', 'value', '350 m', paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
                   'mean_rainfall', 'value', '4 m yr<sup>-1</sup>', paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')), 
                   'soil_ph', 'value', 'pH 5-6 in water', paste('Method ln4:',paste(data.lvl0.df$method[4], collapse = ' ')),
                   'soil_class', 'value', 'Kaiwiki thixotropic, isothermic Typic Hydrandepts', paste('Method ln4:',paste(data.lvl0.df$method[4], collapse = ' ')),
                  'inital_planting', 'value', '1994', paste('Method ln11:', data.lvl0.df$method[11]),
