---
title: "Data Rescue: Veldkamp 1994"
format:
  html:
    toc: true
date: last-modified
...
read_csv(file = table4.file,
                   skip = 1,
                   col_types = cols(.default = col_character())) |>
  kable(caption = read_csv(file = table4.file, 
                                 n_max = 1, col_names = 'caption', 
                                 show_col_types = FALSE)$caption)
```


{{< include Veldkamp1994_Methods.md >}}

# Transcription comparison

```{bash eval=FALSE}
diff --strip-trailing-cr --suppress-common-lines -y temp/Veldkamp1994_Methods_SRS.md Veldkamp1994_Methods_MB.Rmd
```
