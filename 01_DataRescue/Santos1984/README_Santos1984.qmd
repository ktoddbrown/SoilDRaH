...
timelog:
  ...
  - activity: 
      ...
      duration: PT120M 
  - activity: 
      description: Table 1 and BibTex
      who: mbalvarez72 #github username
      #when you started and ended, can be just a year or down to the minute
      start: 2026-05-18
      #alternatively duration can be combined with a being/end
      duration: PT120M
...
diff --strip-trailing-cr --suppress-common-lines -y Santos1984_Table1.csv temp/Santos1984_Table_1_MA.csv
```
...
# You will want to repeat the line below to cross check each csv and md file in the
#... data rescue. Having no lines flagged by this command will ensure that each character matches exactly.
diff --strip-trailing-cr --suppress-common-lines -y temp/Santos1984_Methods_VM.md Santos1984_Methods.md
```
...
- [ ] NationalOceanic1979
  + manually created from paper bibliography, no BibTex citation found online.
---->
