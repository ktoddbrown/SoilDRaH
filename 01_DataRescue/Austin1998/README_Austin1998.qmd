...
Table 1 was modified to remove the sub-tables and flatted sub-tables in certain columns. Table 1 citation was changed from Wagner et al 1991 to @Wagner1990, as the citation was listed in references. 
...
Table 4 was modified to include '-' to represent no data given. There was also a shift of the condition from a row above each subtable to the first column, combining the subtables.
...
diff Austin1998_Table1.csv Austin1998_Table1_MB.csv
```
