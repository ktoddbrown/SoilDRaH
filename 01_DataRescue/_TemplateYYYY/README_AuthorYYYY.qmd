...
timelog:
  ...
  - activity: 
      ...
      #alternatively duration can be combined with a being/end
      duration: PT45M
  - activity: #Suggested that you log each day's activity here
      description: Revise based on feedback
      who: ktoddbrown #github username
      #Over what days did you work on this? Use
      #... https://en.wikipedia.org/wiki/ISO_8601#Dates format.
      start: 2025-11-21
      end: 2025-11-26
      #Estimate how long this took you, below is an example of 30 minutes. Use
      #... https://en.wikipedia.org/wiki/ISO_8601#Durations
      duration: PT30M
version: 'vs20270801' #template version, remove before use
---
