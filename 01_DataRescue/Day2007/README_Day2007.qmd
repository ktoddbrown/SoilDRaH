...
authors: #author scheme from https://quarto.org/docs/journals/authors.html
  - id: angelacanini-a11y #use the github name as an id
    name:
      given: Angela
      family: Canini
    affiliation:
    ...
    role: #TODO define these roles and add reference
      - transcription: primary table1, secondary methods.md #secondary, review
 #     - standardization: review #review
 #     - curation: lead #review
  - id: bcheser #use the github name as an id
    name:
      given: Ben
      family: Cheser
    affiliation:
      - ref: uf
    role: #TODO define these roles and add reference
      - transcription: primary table3 & citations, secondary table2 #secondary, review
 ...
 #    - curation: lead #review
  - id: JennavieveK #use the github name as an id
    ...
    affiliation:
      - ref: uf
    role: #TODO define these roles and add reference
      - transcription: primary table2, secondary table1 & citations #secondary, review
 #     - standardization: lead #review
 #     - curation: lead #review
...
timelog:
  - activity: 
      ...
      start: 2026-04-03 T1530
      #start: YYYY-MM-DD THH:MM
      #alternatively duration can be combined with a being/end
      duration: PT30M
  - activity: 
      description: worked on readme file
      who: vaasukimarupaka #github username
      #when you started and ended, can be just a year or down to the minute
      start: 2026-04-10 T1600
      #start: YYYY-MM-DD THH:MM
      #alternatively duration can be combined with a being/end
      duration: PT20M
  - activity: 
      description: Revise based on feedback from pull request
      who: vaasukimarupaka #github username
      #when you started and ended, can be just a year or down to the minute
      end: 2026-09-02
      #start: YYYY-MM-DD THH:MM
      ...
      duration: PT30M
  - activity: 
      description: Transcribed table 1, table 2, and citations
      ...
      duration: PT120M
  - activity: 
      description: Transcribed table 1
      ...
      duration: PT55M
  - activity: 
      description: secondary transcription for methods
      who: angelacanini-a11y #github username
      #when you started and ended, can be just a year or down to the minute
      end: 2026-04-04
      #start: YYYY-MM-DD THH:MM
      ...
      duration: PT40M
  - activity: 
      description: transcribed table 3
      who: bcheser #github username
      #when you started and ended, can be just a year or down to the minute
      start: 2026-04-03 T1530
      #start: YYYY-MM-DD THH:MM
      #alternatively duration can be combined with a being/end
      duration: PT2H30M
  - activity: 
      description: secondary transcription for table 2
      who: bcheser #github username
      #when you started and ended, can be just a year or down to the minute
      start: 2026-04-04
      #start: YYYY-MM-DD THH:MM
      ...
      duration: PT1H30M
  - activity: 
      description: created citations section
      who: bcheser #github username
      #when you started and ended, can be just a year or down to the minute
      start: 2026-04-10
      #start: YYYY-MM-DD THH:MM
      ...
      duration: PT1H00M
  - activity: 
      description: edited activity section
      who: bcheser #github username
      #when you started and ended, can be just a year or down to the minute
      start: 2026-09-03 T1600
      #start: YYYY-MM-DD THH:MM
      #alternatively duration can be combined with a being/end
      duration: PT10M
  - activity: 
      description: fix bibtex and other formatting issues
...
diff --strip-trailing-cr --suppress-common-lines -y temp/Day2007_Table1_JK.csv Day2007_Table1.csv 
...
diff --strip-trailing-cr --suppress-common-lines -y temp/Day2007_Table2_BC.csv Day2007_Table2.csv 

```

## Table 3

Table 3 was unmodified.

```{r}
#| label: table3Check
#| eval: true #remove when you have the file transcribed

read_csv(file = table3.file, #read in the specific file
         skip = 1, #skip the first line with the caption
         #read everything as a character, don't worry about formatting yet
         col_types = cols(.default = col_character())) |>
  kable(caption = read_csv(file = table2.file, #read in that file again but...
...
diff --strip-trailing-cr --suppress-common-lines -y temp/Day2007_Table3_VM.csv Day2007_Table3.csv 
...
diff --strip-trailing-cr --suppress-common-lines -y temp/Day2007_Methods_VM.md Day2007_Methods.md
