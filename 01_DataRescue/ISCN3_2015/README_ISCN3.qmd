...
timelog:
  ...
  - activity:
      ...
      duration: PT3H
  - activity:
      description: final check for level 1
      who: ktoddbrown
      start: 2026-08-25
      duration: PT30M
---
...
precisions.ls <- list(latLong_digits = 4, #assume lat/lon precision of 0.0001
                      ...
                      #assume precision of 0.01% for carbon fraction that is
                      # often measured using an elemental analyzer, this could
                      #  be method specific in the future.
                      carbonFraction_digits = 2,
                      #since this is normalized to the layer thickness, use a
                      # very high precision here. This ends up being not used
                      #  because we filter out NCSS
...
Things to also note here:
  ...
  - Zero reference for depth is drawn from the profile table
...
coarse_fraction.df <- layer.df  |>
  ...
  mutate(unit = 'mass-percent',
         #put in the column id so that it will match the other variables
