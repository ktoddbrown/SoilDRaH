...
Most of the layer identifiers for upper and lower bounds were dealt with in the layer pre-processing. Create a depth interval data frame by selecting the layer related columns and transforming it to a data tuple. 
