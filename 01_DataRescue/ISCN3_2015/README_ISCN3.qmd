...
studyMeta <- tribble(~of_variable, ~is_type, ~with_entry, ~from_source,
                     #TODO figure out how to convert the citation to a string
                   'citation', 'value', data.lvl0.ls$citation$primary, 'EDI download page',
                   ...
                   'observation_date', 'unit', 'days since 1900-01-01', 'infered given past history in Excel.')
