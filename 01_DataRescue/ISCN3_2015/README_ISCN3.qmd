...
TODO: add in documentation for the citation corrections including what files were changed
...
#TODO Add in skips and captions appropriately here. Check read in formats
data.lvl0.ls <- list(
  ...
  data = list(
    TableCitation = list(
      #manual correction to out of date citations, orginally
      ...
      #no submission template meta data
    ), #end citation list
    TableDataset = list(
    ...
    TableSite = list(
      #no primary data here for sites
...
## Primary data: Profile table

```{r}

knitr::kable(data.lvl0.ls$data$TableProfile$primary |> 
               head()) |>
  kable_paper() |>
  scroll_box(width = "100%", height = "300px")
...
## Primary data: Dataset table

```{r}

knitr::kable(data.lvl0.ls$data$TableDataset$primary |> 
               head()) |>
  kable_paper() |>
  scroll_box(width = "100%", height = "300px")
...
## Primary data: Citation table

```{r}

knitr::kable(data.lvl0.ls$data$TableCitation$primary |> 
               head()) |>
  kable_paper() |>
  scroll_box(width = "100%", height = "300px")
