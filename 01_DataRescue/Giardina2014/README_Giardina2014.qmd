...
## Figure 2
  ...
  Figure 2 was modified by removing the trend lines and has a different grid pattern than the original.
...
ggplot(data = figure2dataframe)+
  ...
  geom_errorbar(aes(
    ...
    ymin = elow,
    ymax = ehigh))+
 facet_grid(`y value unit`~`depth (cm)`, scales='free',)+
  labs(x='MAT °C')
