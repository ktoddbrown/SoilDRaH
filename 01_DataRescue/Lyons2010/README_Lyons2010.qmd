...
timelog:
  ...
  - activity:
      description: revise based on feedback, see https://github.com/ktoddbrown/SoilDRaH/issues/262. Changes include more details in the commented guidence, additional table and figure examples.
      who: ktoddbrown
      start: 2026-06-18 T1430
      duration: P45M
  - activity: 
...
figureM.file <- 'Lyons2010_Figure2.csv'
...
+ Do
  - [ ] Extract points from Figure 1-3 and export it to csv
