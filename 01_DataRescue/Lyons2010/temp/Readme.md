This folder should be used to hold two kinds of files:
...
Files not committed are up to you, but can include an article pdf or a spreadsheet file.
...
*Pull requests that have pdf or spreadsheet files will likely be rejected.*
