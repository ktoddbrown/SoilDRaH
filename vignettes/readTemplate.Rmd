...
#read each csv in as a dataframe
...
Read in annotation table as a dataframe. This needs to be manually created either from the provided metadata of the download files or associated publications.
