...
We found this format challenging to parse ourselves and instead relied on `pangaear::pg_data`, which we then further processed into a long data format.

```{r file= '../R/readCPEAT.R'}
