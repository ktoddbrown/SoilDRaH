...
This data set includes a graphica meta-data at the front of a tab separated data table.
See example below:
...
TODO Start here describing the metadata annotations
TODO Echo the data annotations as an example of the data structure documentation

# START HERE RECODING EVERYTHING
...
###Shoestring all the data
  ...
  long.df <- plyr::ldply(CPEAT.original$original, .id = 'doi',
