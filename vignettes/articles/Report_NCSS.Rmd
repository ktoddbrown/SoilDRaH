...
The NCSS Data (Lab Data) was collected the by the National Cooperative Soil Survey of the United States Department of Agriculture.
...
While we have integrated the available metedata into the data annotations presented here, we have not completed the annotations beyond the description imports for soil carbon stock estimates, bulk density, organic carbon fraction, layer depth, and geo-location.
...
```{r eval=FALSE}
#TODO rerun after updating the checkAnnotations to run off of the csv file
...
if(checkAnnotations(filename = '../../data/NCSS_Annotations.csv') == 0){
  print('Annotations check out!')
}

checkAnnotations(filename = '')
```
