...
biomass_annotations <- 
  ...
  rename(read_xlsx(file_path, col_names=FALSE, range="Data Description!A4:C17"), c("column_id"=...1, "info"=...2, "unit"=...3)) %>% 
  mutate(
  ...
  add_row(table_id=base_file_name, column_id=NA, of_variable=NA, is_type="note", with_entry=as.character(read_xlsx(file_path, col_names=FALSE, range="Data Description!B20")), .before=1)
