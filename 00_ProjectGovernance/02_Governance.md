...
Transparent governance ensures that everyone knows (or knows how to find) how the project makes decisions.
This includes what are the decisions that were made, how were they arrived at, and who made these decisions.
...
Currently those held accountable for the work are responsible for consenting to policies that govern that work, as of 2026 the BDFN is solely accountable for the work here.

In the future,
decisions that affect individuals doing work are consented by those individuals.
This means that any policy decisions are made by individuals doing the work that is most directly affected by that policy.
These individuals are, in turn, responsible for having an informed background and gathering appropriate feedback from those tangentially affected by the policy.
...
Does other information need to be fleshed out before a decision can be made?
*Deciding* entails identifying a specific proposal and gaining consent from the decision makers.
*Revision* phase provides formulation reflection on the decision that was made so that future decisions are improved.

People affected by the decision should be involved, directly or indirectly, in all three phases of decision making.
Once the project transitions to circle governance, individuals on the circle with the most aligned domain must be involved in all three phases and are responsible for actively consenting or objecting to decisions.
