...
<!-- what purpose does this serve? this file does not exist in this file group -->
```{bash eval=FALSE}
...
#View(data.lvl0.df)
# creates a list of lists (I think) as a dataframe
# df pulls in citations as key value pairs, 
# methods as a line by line read of a text block,
# and two tables --- table1 and table3
# everything is read in as text strings ( which is character 'type' in R parlance, I think)
```
