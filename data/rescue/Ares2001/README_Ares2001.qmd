...
temp_evel <- data.lvl1.ls$primary|>
  ...
  mutate(
    ...
    `mean_air_temperature::value` = if_else(
      is.na(`mean_air_temperature::value`),
      23.15 - 0.006429 * `elevation::value`, `mean_air_temperature::value`),
    #N = 3, Adjusted R-squared:  0.9886; p-value: 0.0482
    `total_rainfall::value` = if_else(
      is.na(`total_rainfall::value`),
