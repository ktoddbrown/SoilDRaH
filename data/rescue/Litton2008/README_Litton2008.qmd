...
Data from Figure 6 pulled using Plot Digitizer and altered into a csv. SD stands for Standard Deviation, Standard deviation high and lows from bar graph included as separate columns. Letters indicating statistically significant differences were listed in a new column titled "letter".
